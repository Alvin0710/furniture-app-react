...
const TrustedBy = () => {
    return (
        <div className='bg-[#F4F6F6] mt-[10rem] md:mt-5 w-full py-[4rem] my-[4rem] md:my-0 flex justify-center px-4'>
            <div className='w-full'>
                <h1 data-aos="fade-up" data-aos-duration="500" className='capitalize text-center break-words font-poppins font-semibold text-xl tracking-wider pb-9'>TRUSTED BY OVER 1K+ COMPANIES</h1>
